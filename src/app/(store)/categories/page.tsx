...
export default function CategoriesPage() {
  ...
  const activeCategoryTitle = activeCategoryObj?.name ?? "All Snacks";
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-3 text-sm sm:text-base text-theme-text-subtle max-w-2xl mx-auto leading-relaxed">
              Explore our handcrafted South Indian snacks organized by authentic flavors, savory textures, and sweet delicacies.
            </p>
          </div>
        </div>
      </div>
